<#	
	...
	Source: https://github.com/bwya77/O365HTMLReport/blob/master/HTMLReport.ps1
	===========================================================================
     Version:       1.0.5
...
$RightLogo = "http://www.relianceit.com.au/_assets/images/skins/reliance_logo_colour.png"

#Client Name you are running the report for
...
#Location the report will be saved to
	...
	$Year = (Get-Date).Year
	$ReportName = ( "$Year" + "-" + "$Month" + "-" + "$Day" + "-" + "O365 Tenant Report-" + $ClientName)
	#>
$Date = Get-Date -Format "yyyy-MM-dd"
$ReportName = ( "$Date" + "-" + "O365 Tenant Report-" + $ClientName)
$ReportSavePath = "C:\RelianceIT\Reports"
...
{
  New-Item -ItemType Directory -Path $ReportSavePath
  write-host -foregroundcolor Cyan "`nFolder Created: $ReportSavePath"
}


Save-HTMLReport -ReportContent $rpt -ShowReport -ReportName $ReportName -ReportPath $ReportSavePath

Write-Host -foregroundcolor $OutputColor "`nFile $ReportName Created"
Invoke-Item $ReportSavePath
