...
Foreach ($User in $Users)
{
	...
	$Office=(Get-MsolUser -UserPrincipalName $User.UserPrincipalName).office
...
$Result = @()
$AllUsers = Get-MsolUser -All | Where-Object { $_.isLicensed -eq "TRUE" } | Sort-Object DisplayName,UserPrincipalName
...
$Result | Select UserName, UserPrincipalName, ManagerName,ManagerMail  | Export-CSV "C:\RelianceIT\Reports\MAASUsersManagerInfo.CSV" -NoTypeInformation -Encoding UTF8
