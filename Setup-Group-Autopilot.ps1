...
# Script
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
$GroupName = "AAD - Autopilot"
$GroupDescription = "Dynamic Group for Autopilot devices (to be used with Autopilot and Intune)"
$MemberRule = "(device.devicePhysicalIDs -any _ -contains ""[ZTDId]"")"
