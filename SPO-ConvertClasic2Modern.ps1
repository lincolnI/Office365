...
.Example
    ...
    .\SPO-ConvertClasic2Modern.ps1 -SourceUrl "https://relianceit.sharepoint.com/" -TakeSourcePageName:$true
    .\SPO-ConvertClasic2Modern.ps1 -SourceUrl "https://inlandtech.sharepoint.com/ITF/" -TakeSourcePageName:$true
